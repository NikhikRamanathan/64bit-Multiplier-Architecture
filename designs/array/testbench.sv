...
// Description: Functional verification suite for the 64-bit Array Multiplier.
//              Applies targeted test vectors and monitors output correctness.
// =======================================================================
...
module testbench;
    ...
    initial begin
        $dumpfile("array_power.vcd");
        $dumpvars(0, testbench);

        // Display simulation banner
        $display("// =====================================================");
        $display("//   INITIALIZING ARRAY MULTIPLIER VERIFICATION         ");
        $display("// =====================================================");
        ...
        // ---------------------------------------------------------
        // TEST CASE 3: 32-bit Boundary Scale Test
        // ---------------------------------------------------------
